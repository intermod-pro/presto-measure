...
# control_amp = 0.1594  # FS <-- pi pulse from data/rabi_amp_20210428_101944.h5, qubit 1
control_amp = 0.1188  # FS <-- pi pulse from data/rabi_amp_20210428_164251.h5, qubit 2
...
# *** Plot data ***
# *****************
fig1, fig2, fig3 = load_t1.load(save_path)
